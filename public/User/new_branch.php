<?php if(!isset($conn)){ include ('includes/db_connect.php');  } ?>
<style>
  textarea{
    resize: none;
  }
	...
	<div class="card card-outline card-primary">
  	...
  	<div class="card-footer border-top border-info">
  		<div class="d-flex w-100 justify-content-center align-items-center">
  			...
  			<a class="btn btn-flat bg-gradient-secondary mx-2" href="./indexxx.php?page=branch_list">Cancel</a>
  		</div>
  	</div>
	</div>
</div>
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					...
					setTimeout(function(){
              location.href = 'indexxx.php?page=branch_list'
					},2000)
				}
			}
		})
