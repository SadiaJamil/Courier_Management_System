	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary " href="./indexxx.php?page=new_branch"><i class="fa fa-plus"></i> Add New</a>
			</div>
		</div>
		<div class="card-body">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center">
		                    <div class="btn-group">
		                        <a href="indexxx.php?page=edit_branch&id=<?php echo $row['id'] ?>" class="btn btn-primary btn-flat ">
